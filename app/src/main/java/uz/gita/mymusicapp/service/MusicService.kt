package uz.gita.mymusicapp.service
...
import uz.gita.mymusicapp.broadcast.CallReceiver
...
/**
 *    Created by Kamolov Samandar on 31.10.2023 at 23:08
 */
...
class MusicService : Service() {
    ...
    private fun doneCommand(commandEnum: CommandEnum) {
        when (commandEnum) {
            ...
            CommandEnum.PLAY -> {
                val data = if (MyEventBus.currentCursorEnum == CursorEnum.SAVED)
